-- Principal role and assignment support.
-- Run after the base schema and the principal invite migration.
...
alter table public.registration_requests
  ...
  add column if not exists approved_profile_id uuid references public.profiles(id),
  add column if not exists approved_school_id uuid references public.schools(id),
